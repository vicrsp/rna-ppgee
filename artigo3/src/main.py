...
def run_classification_experiment():
    ...
    experiment_classification.plot_final_scores('/home/victor/git/rna-ppgee/artigo3/report/figures')
    experiment_classification.save_final_scores_table('/home/victor/git/rna-ppgee/artigo3/report/tables')
#%% Run experiment
